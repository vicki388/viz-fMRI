!function(e){if("object"==typeof exports&&"undefined"!=typeof module)module.exports=e();else if("function"==typeof define&&define.amd)define([],e);else{var f;"undefined"!=typeof window?f=window:"undefined"!=typeof global?f=global:"undefined"!=typeof self&&(f=self),f.vd=e()}}(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
"use strict";
...
var voidTags = _interopRequire(require("./void-tags"));
...
var Element = function Element(tagName, isVoid) {
  ...
  if (null != isVoid) {
    ...
    this["void"] = null != voidTags[tagName];
  }
};
...
Element.prototype.set = function (prop, val) {
  if ("object" == typeof prop) {
    ...
    } else if ("style" == prop && val && "object" == typeof val) {
      var css = "";
      for (var k in val) {
        if (css.length) css += ";";
        css += "" + k + ":" + val[k];
...
Element.prototype.toHTML = function () {
  ...
  for (var key in this.props) {
    html += " " + key + "=" + JSON.stringify(this.props[key]);
  }
...
},{"./node":3,"./text":6,"./void-tags":7,"array-flatten":8}],2:[function(require,module,exports){
"use strict";
...
},{"./element":1,"./text":6,"vcss":11}],6:[function(require,module,exports){
"use strict";
...
},{"void-elements":16}],8:[function(require,module,exports){
/**
...
},{"./scope":14}],10:[function(require,module,exports){
"use strict";
...
},{"./animation":9,"./block":10,"./media":12,"./ruleset":13,"./scope":14,"./sheet":15}],12:[function(require,module,exports){
"use strict";
...
},{"./scope":14}],13:[function(require,module,exports){
"use strict";
...
},{"./block":10}],14:[function(require,module,exports){
"use strict";
...
},{"./block":10,"./ruleset":13}],15:[function(require,module,exports){
"use strict";
...
},{"./animation":9,"./media":12,"./scope":14}],16:[function(require,module,exports){
/**
